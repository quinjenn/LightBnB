...
const getAllProperties = function (options, limit = 10) {
  ...
  // owner_id passed in > show properties belonging to that owner
  if (options.owner_id) {
    if (queryParams) {
      queryString += `AND `
    } else {
  ...
  // min rating of property > equal to or higher
...
const addProperty = function (property) {
  const propertyElements = [property.owner_id, property.title, property.description, property.thumbnail_photo_url, property.cover_photo_url,
